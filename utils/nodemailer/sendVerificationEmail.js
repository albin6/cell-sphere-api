...
const sendVerificationEmail = async (email, otp) => {
  try {
    const mail_response = await mail_sender(
      email,
      "CellSphere - Verify Your Email",
      `
        <div style="font-family: Arial, sans-serif; color: #333;">
          <h2 style="color: #0a74da;">Welcome to CellSphere!</h2>
          <p>Dear user,</p>
          <p>Thank you for registering with <strong>CellSphere</strong>. To complete your sign-up process, please verify your email address by using the OTP code provided below:</p>
          ...
          <p>We look forward to providing you with the best mobile solutions at CellSphere.</p>
